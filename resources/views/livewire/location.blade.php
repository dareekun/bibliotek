<div>
    <div class="row">
        <div class="col-12">
            <div class="row my-4">
                <div class="col-6">
                    <button class="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#addlocation">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button class="btn btn-sm btn-outline-danger" wire:click="cancelloc({{$index}})"><i
                                ...
                                <td>{{$loc->desc}}</td>
                                <td>
                                    <button class="btn btn-sm btn-outline-primary" wire:click="editloc({{$index}})"><i
                                            class="far fa-edit"></i></button>
                                    <button class="btn btn-sm btn-outline-danger"
                                        wire:click="deleteloc({{$loc->id}})"><i class="far fa-trash-alt"></i></button>
                                </td>
                                @endif
                            </tr>
                            @endforeach
