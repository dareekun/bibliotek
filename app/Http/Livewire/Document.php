...
class Document extends Component
{
    ...
    public function render()
    {
        if (Auth::user()->role == 'developer') {
            ...
            ->join('location', 'location.id', '=', 'document.location')
            ...
            'users.name as pic', 'document.statusdoc as statusdoc', 'category.desc as category', 'location.code as locode', 'category.code as catcode')->where('document.statusdoc', $this->condition)
            ->get();
